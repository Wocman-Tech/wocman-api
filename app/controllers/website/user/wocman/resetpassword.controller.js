        ...
        .then(users => {
            ...
            .then(khj => {
                ...
                let response = {
                    body: {
                      name: users.username,
                      intro: "Welcome to Wocman Technology! We're very excited to have you on board. <br/>Thank you for completing your signup. Click or Copy this link below to any browser to login: "+verification_link,
                    },
                };
