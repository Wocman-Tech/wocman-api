...
exports.isAdmin2FASMS = (req, res, next) => {
...
exports.resendisAdmin2FASMS = (req, res, next) => {
...
exports.isAdmin2FA = (req, res, next) => {
    var sentMail = false;
...
exports.resendIsAdmin2FA = (req, res) => {
    var sentMail = false;
    var searchemail = {};
    if(req.body.email && req.body.email !== ''){
        searchemail = {'email': req.body.email}
...
exports.activateIsAdmin2FA = (req, res) => {
